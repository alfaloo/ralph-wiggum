...
Read `artifacts/{{PROJECT_NAME}}/spec.md` to understand the existing requirements before making any changes.

## Step 2: Amend the spec

Update `artifacts/{{PROJECT_NAME}}/spec.md` to incorporate the information from the Q&A above.
